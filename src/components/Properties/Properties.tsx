...
export function Properties() {
  ...
  const dataFilteredHouses = properties
    ? properties.slice(0, counterHouses)
    : [];

  return (
    <Transition className="px-4 py-8 md:py-32 md:px-40">
      {dataFilteredHouses.length > 0 ? (
        <div className="grid grid-cols-2 gap-4 md:grid-cols-4" id="properties">
      ...
      <div className="text-center my-7 mt-10">
        {properties && counterHouses < properties.length && (
          <button
